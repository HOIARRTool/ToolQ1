...
def get_consultation_response(incident_description: str) -> str:
   ...
   CSD101 เกิดปัญหาใน Dental Tx ผู้ป่วยโรค DM เช่น Hypo-Hyperglycemia/แผลหายช้า/Advance Periodontitis
    ...
    เหตุผล: ความคลาดเคลื่อนทางยาในขั้นตอนต่างๆ และโดยเฉพาะจากยาชื่อพ้องมองคล้าย    
    กระบวนการที่ควรทบทวน: มาตรการแยกยา LASA, การตรวจสอบข้ามสายงาน (แพทย์-เภสัชกร-พยาบาล)    
    มาตรฐาน HA: ตอนที่ II หมวดที่ 6 (MMS) ข้อ 6.1 ค.(2) และ 6.2
    ...
    เหตุผล: ความผิดพลาดจากการเชื่อมต่อสายสวนและอุปกรณ์    
    กระบวนการที่ควรทบทวน: การตรวจสอบสายก่อนเชื่อมต่อ, การใช้ Luer lock, นโยบายการใช้ Infusion pump ที่ปลอดภัย    
    มาตรฐาน HA: ตอนที่ III หมวดที่ 4 ข้อ 4.2 (PCD.2) ข้อย่อย (1)
    ...
    รหัส CPP101: Patient Identification    
    [Patient Safety] P 1 Patient Identification    
    เหตุผล: การบ่งชี้ตัวผู้ป่วยผิดพลาดโดยตรง    
    กระบวนการที่ควรทบทวน: การใช้ตัวบ่งชี้อย่างน้อย 2 อย่าง, การกำหนดมาตรฐานป้ายข้อมือ    
    มาตรฐาน HA: ตอนที่ III หมวดที่ 1 (Access & Entry) (8)
    ...
    **คำสั่ง:**
    ...
    จัดกลุ่มผลลัพธ์ ตาม "safety_domain" ทั้ง 3 ประเภท ได้แก่ "Patient Safety", "Personnel Safety", และ "People Safety"   
    ...
    หากอุบัติการณ์หนึ่งเกี่ยวข้องกับหลาย Domain (เช่น กระทบทั้งบุคลากรและผู้ป่วย) ให้แสดงผลทั้งหมดโดยแยกเป็นหัวข้อของแต่ละ Domain    
