...
st.markdown(
    ...
    ">
        ...
        <img src="https://github.com/HOIARRTool/appqtbi/blob/main/messageImage_1763018963411.jpg?raw=true" style="height:55px;">
        <img src="https://mfu.ac.th/fileadmin/_processed_/6/7/csm_logo_mfu_3d_colour_15e5a7a50f.png" style="height:65px;">
        <img src="https://github.com/HOIARRTool/appqtbi/blob/main/logoSHS.png?raw=true" style="height:48px;">
    </div>
    """,
